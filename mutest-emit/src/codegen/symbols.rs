...
pub mod path {
    super::paths! {
        ...
        CrateEntryPointsInternalTests (::mutest_runtime::CrateEntryPoints::InternalTests),
        CrateEntryPointsPublicInterface (::mutest_runtime::CrateEntryPoints::PublicInterface),
