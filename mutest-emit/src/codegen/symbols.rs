...
pub mod path {
    super::paths! {
        ...
        CargoTargetKindBin (::mutest_runtime::CargoTargetKind::Bin),
        CargoTargetKindExample (::mutest_runtime::CargoTargetKind::Example),
        CargoTargetKindTest (::mutest_runtime::CargoTargetKind::Test),
        ...
        MUTATION_CONFLICT_MATRIX (crate::mutest_generated::MUTATION_CONFLICT_MATRIX),
        MUTATION_CONFLICTS (crate::mutest_generated::MUTATION_CONFLICTS),
        MutationConflictsMeta (::mutest_runtime::MutationConflictsMeta),
        mutation_conflicts_meta_from_static (::mutest_runtime::MutationConflictsMeta::from_static),
        ...
        MutationParallelismDynamicallyScheduled (::mutest_runtime::MutationParallelism::DynamicallyScheduled),
